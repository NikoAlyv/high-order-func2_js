...
//   const orderCount = orders.filter((count)=>count.price>=1000)
//   console.log(orderCount);

//! find by customer name

//   const customerFind = customers.filter(customer=>customer.name.toLowerCase()==="alice")
//   console.log(customerFind);

//! find index in orders

// const  orderFind = orders.findIndex((order)=>order.orderId===102)
// console.log(orderFind);

//! find order
// const customerFind = customers.filter((customer)=>{
...
// const compatibilityFind = customers.forEach((customer) =>
